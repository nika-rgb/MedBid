    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="form-group">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.date-of-birth" class="${properties.kcLabelClass!}">
                        Date of birth</label>
                </div>

                <div class="${properties.kcInputWrapperClass!}">
                    <input type="date" class="${properties.kcInputClass!}"
                           id="user.attributes.date-of-birth" name="user.attributes.date-of-birth"
                           value="${(register.formData['user.attributes.date-of-birth']!'')}"/>
                </div>
            </div>
